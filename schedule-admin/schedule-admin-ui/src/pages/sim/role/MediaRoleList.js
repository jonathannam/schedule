...
import { deleteMediaRoleAPI, deleteMediaRolesAPI } from '../../../service/schedule/schedule.role.service';
// sections
        ...
        <HeaderBreadcrumbs
          ...
          links={[
            { name: translate('menu.dashboard'), href: PATH_DASHBOARD.root },
            {
              ...
              href: PATH_DASHBOARD.schedule.roles,
            },
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.schedule.newRole}
                        ...
                        {TABLE_HEAD.map(head => {
                          ...
                          if (head.id === '')
                            return <TableCell align="right" key={head.id}>
                              <DataGridMoreMenu pathEdit={`${PATH_DASHBOARD.schedule.root}/role/${id}/edit`}
                                pathView={`${PATH_DASHBOARD.schedule.root}/role/${id}/view`} onDelete={() => handleDeleteItem(id)} />
                            </TableCell>;
