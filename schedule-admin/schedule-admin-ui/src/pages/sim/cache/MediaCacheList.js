...
import { deleteMediaCacheAPI } from '../../../service/schedule/schedule.cache.service';
// sections
...
import CacheListToolbar from '../../../sections/schedule/cache/CacheListToolbar';
import { getMediaCaches } from '../../../redux/slices/sim/schedule.cache';
        ...
        <HeaderBreadcrumbs
          ...
          links={[
            { name: translate('menu.dashboard'), href: PATH_DASHBOARD.root },
            {
              ...
              href: PATH_DASHBOARD.schedule.caches,
            },
                        ...
                        {TABLE_HEAD.map(head => {
                          ...
                          if (head.id === '')
                            return <TableCell align="right" key={head.id}>
                              <DataGridMoreMenu pathEdit={`${PATH_DASHBOARD.schedule.root}/cache/${id}/keys`}
                                pathView={`${PATH_DASHBOARD.schedule.root}/cache/${id}/keys`} onDelete={() => handleDeleteItem(id)} />
                            </TableCell>;
