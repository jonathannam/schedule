...
import { deleteCategoriesAPI, deleteCategoryAPI } from '../../../service/schedule/schedule.category.service';
...
export default function CategoryList() {
  ...
  const TABLE_HEAD = [
    ...
    { id: 'title', label: translate('sim.category.title'), alignRight: false, checked: true, sort: true },
    { id: 'createdAt', label: translate('sim.category.createdAt'), alignRight: false, checked: true, sort: true },
  ...
  return (
    <Page title={translate('schedule.category.listCategory')}>
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading={translate('schedule.category.listCategory')}
          links={[
            { name: translate('schedule.dashboard'), href: PATH_DASHBOARD.root },
            {
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.schedule.newCategory}
                          ...
                          if (head.id === '')
                            return (
                              <TableCell align="right" key={head.id}>
                                <DataGridMoreMenu
                                  pathEdit={`${PATH_DASHBOARD.schedule.root}/category/${id}/edit`}
                                  pathView={`${PATH_DASHBOARD.schedule.root}/category/${id}/view`}
