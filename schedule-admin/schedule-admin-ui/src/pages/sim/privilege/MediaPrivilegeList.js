...
import { getMediaPrivileges, setMediaPrivilegeSearch } from '../../../redux/slices/sim/schedule.privilege';
import { deleteMediaPrivilegeAPI, deleteMediaPrivilegesAPI } from '../../../service/schedule/schedule.privilege.service';
// sections
        ...
        <HeaderBreadcrumbs
          ...
          links={[
            { name: translate('menu.dashboard'), href: PATH_DASHBOARD.root },
            {
              ...
              href: PATH_DASHBOARD.schedule.privileges,
            },
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.schedule.newPrivilege}
                              ...
                              <TableMoreMenu
                                actions={
                                  <>
                                    ...
                                    <MenuItem component={RouterLink} to={`${PATH_DASHBOARD.schedule.root}/privilege/${id}/view`} >
                                      <Iconify icon={'eva:eye-fill'} />
                                      {translate("button.view")}
                                    </MenuItem>

                                    <MenuItem component={RouterLink} to={`${PATH_DASHBOARD.schedule.root}/privilege/${id}/edit`} >
