...
import { createEmailAPI, updateEmailAPI } from '../../../service/schedule/schedule.email.service';
...
export default function EmailNewForm({ isEdit, isView, currentItem }) {
  ...
  const onSubmit = async (data) => {
    ...
    if (resp.code === '200') {
      ...
      navigate(PATH_DASHBOARD.schedule.emails);
            ...
            <Stack spacing={3}>
              ...
              {isView ? (
                <Button
                  ...
                  to={`${PATH_DASHBOARD.schedule.root}/email/${currentItem?.id}/edit`}
                  size="large"
